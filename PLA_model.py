...
class PLA:
    ...
    def fit(self,X,y,pocket):
        ...
        self.class_two=np.copy(class_other)
        y_binary=np.copy(y)
    ...
    def _2D_3D_show(self,X,y):
        if(X.shape[1]==3):
            ...
            w0,w1,w2,w3=self.W_vector[0],self.W_vector[1],self.W_vector[2],self.W_vector[3]
            x1=X[:,0]
            x2=X[:,1]
            ...
            w0,w1,w2=self.W_vector[0],self.W_vector[1],self.W_vector[2]
            x=X[:,0]
